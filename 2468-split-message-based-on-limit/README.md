<h2><a href="https://leetcode.com/problems/split-message-based-on-limit">2468. Split Message Based on Limit</a></h2><h3>Hard</h3><hr><p>You are given a string, <code>message</code>, and a positive integer, <code>limit</code>.</p>
